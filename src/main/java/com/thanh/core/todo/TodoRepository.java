...
import com.thanh.core.common.BaseRepository;
 ...
 */
interface TodoRepository extends BaseRepository<Todo, Long>, CustomTodoRepository {
...
//            "ORDER BY t.title ASC")
    List<TodoSearchResultDTO> findBySearchTerm(@Param("searchTerm") String searchTerm);
